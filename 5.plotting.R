...
p
ggsave("./figures/Peak_trendline3.png", plot = p, device = "png", width = 6, height = 4, units = "in", dpi = 300) # Figure 1
...
p2 = ggplot(temp5, aes(x=year, y=slope, fill=Tissue_Type)) +
  ...
  theme(legend.position="none")
p2
ggsave("./figures/Regression_Coefficient3.png", plot = p2, device = "png", width = 6, height = 4, units = "in", dpi = 300) # Figure 2.1
...
p3
ggsave("./figures/Average_Fragment4.png", plot = p3, device = "png", width = 6, height = 4, units = "in", dpi = 300) # Figure 4
...
p4 = ggplot(temp5, aes(year, median, fill=Tissue_Type)) +
  ...
  theme(legend.position="none")
p4
# ggsave("./figures/median_Fragment4.png", plot = p4, device = "png", width = 6, height = 4, units = "in", dpi = 300)
