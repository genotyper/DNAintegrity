...
png("figures/both_sem.png", width = 8, height = 4, units = "in", res = 600)
par(mfrow=c(1,2))
plot(f[[1]])
plot(f[[2]])
dev.off()
...
ggsave("./figures/kurtosis_mode.png", plot = p, device = "png", width = 6, height = 4, units = "in", dpi = 600) # Figure 4
